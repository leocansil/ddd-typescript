...
import EnviaConsoleLog1WhenConsumerIsCreated from "../customer/handler/envia-console-log1-when-consumer-is-created.handler";
import EnviaConsoleLog2WhenConsumerIsCreated from "../customer/handler/envia-console-log2-when-consumer-is-created.handler";
import CustomerCreatedEvent from "../customer/customer-created.event";
import EnviaConsoleLogWhenConsumerChangeAddress from "../customer/handler/envia-console-log-when-change-address.handler";
